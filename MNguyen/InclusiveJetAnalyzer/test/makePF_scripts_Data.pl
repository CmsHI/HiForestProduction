...
@files = `ls /pnfs/cmsaf.mit.edu/t2bat/cms/store/user/mnguyen/HICorePhysics/Jet50-PromptReco-Runs_151077*/*/RECOPAT*.root`;
...
foreach $file (@files)
{
    ...
    $outputfile = "PFjetTree_".$run[0]."_".$runfile[11];
    ...
    print OUT "cmsRun PFJetAnalyzer_Data_cfg.py files=dcache:".$file." output=dcache:/pnfs/cmsaf.mit.edu/t2bat/cms/store/user/mnguyen/InclusiveJetAnalyzer/HIData_Jet50U/".$outputfile."\n";
